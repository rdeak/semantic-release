...
dependencies:
  ...
  '@rdeak/semantic-release-config':
    specifier: ^1.2.1
    version: 1.2.1(semantic-release@23.1.1)
  semantic-release:
    specifier: ^23.1.1
    version: 23.1.1
...
packages:
  ...
  /@rdeak/semantic-release-config@1.2.1(semantic-release@23.1.1):
    resolution: {integrity: sha512-Xqjhw+3NYJYLfxRVQ39YU6UgQgUwpKYKKZFoes+R5WS2qGL+JzSjEtOwK3/ftHpaMmMr+0B/nRdb34eMaVGF9w==}
    peerDependencies:
      semantic-release: '>=15'
    dependencies:
  ...
  /@semantic-release/github@10.0.4(semantic-release@23.1.1):
    resolution: {integrity: sha512-eHCfW3jlzax5OKd5nTovlvoCdg+b9YBa31M2JGT1KmzmJR3TIalu2ahVU+V/xATVeOx+S8fbCiPnBBgMlzH5Vw==}
    engines: {node: '>=20.8.1'}
    peerDependencies:
      semantic-release: '>=20.1.0'
    dependencies:
